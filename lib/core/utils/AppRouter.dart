...
abstract class AppRouter {
  ...
  static const kOnboard_1_View = "/onboard1View";
  static const kOnboard_2_View = "/onboard2View";
  static const kOnboard_3_View = "/onboard3View";
  ...
  static final GoRouter router = GoRouter(
      routes: [
        ...
        GoRoute(path: kOnboard_1_View,builder: (context,state)=>const Onboarding01()),
        GoRoute(path: kOnboard_2_View,builder: (context,state)=>const Onboarding02()),
        GoRoute(path: kOnboard_3_View,builder: (context,state)=>const Onboarding03()),
